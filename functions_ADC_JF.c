...
changes from 1.0.1
	...
	32728 changed to 32767 (needed to be 2**15 - 1  (nice catch John)
////////////////////////////////////////////////////////////////*/
...
unsigned int read15bitVoltageOffset(void)
{
	...
	//NOTE: I used alot of extra typecasting to ensure that the value would come out the way I intended
	//			It may be usesless I never checked it all.
	result = read15bitOversample() * ((float)( (float)(5-0) / (float)(32767) ) * 10000);//2**15 = 32768 for the 15 bit resolution			//10000 to display in .1 mV
	return result;
}
